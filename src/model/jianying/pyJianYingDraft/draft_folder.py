...
class DraftFolder:
    ...
    def create_draft(self, draft_name: str, width: int, height: int, fps: int = 30, *,
                     ...
                     platform: Literal["win", "mac", "linux"] = "win") -> ScriptFile:
        ...
        Args:
            ...
            platform (`str`, optional): 操作系统平台 (win/mac/linux). Mac系统会使用不同的文件名和格式. 默认为"win".
        ...
        # Mac系统使用 draft_info.json，Windows/Linux 使用 draft_content.json
        ...
        # Mac系统特殊处理
        if platform == "mac":
            # 修改 draft_meta_info.json，添加 platform 字段
            ...
            # 修改 draft_content 中的 platform 相关字段
            script_file.content["platform"]["os"] = "mac"
            script_file.content["last_modified_platform"]["os"] = "mac"
